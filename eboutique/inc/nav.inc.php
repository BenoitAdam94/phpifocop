    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    	<a class="navbar-brand" <?php echo URL; ?>index.php">eBoutique</a>
    	...
    	<div class="collapse navbar-collapse" id="navbarsExampleDefault">
    		<ul class="navbar-nav mr-auto">
    			...
    			<li class="nav-item dropdown">
    				<a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Admininistration</a>
    				<div class="dropdown-menu" aria-labelledby="dropdown01">
    					<a class="dropdown-item" href="<?php echo URL; ?>admin/gestion_article.php">gestion des articles</a>
    					<a class="dropdown-item" href="<?php echo URL; ?>admin/gestion_membre.php">Gestion des commandes</a>
    					<a class="dropdown-item" href="<?php echo URL; ?>admin/gestion_commandes.php">Gestion des commandes</a>
						<a class="dropdown-item" href="<?php echo URL; ?>admin/statistiques.php">Gesion des statistiques</a>
    				</div>
    			</li>
